      ...
      <div className="sticky top-16 z-40 bg-white/90 backdrop-blur-md border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex gap-8 overflow-x-auto py-4 hide-scrollbar -mx-4 px-4 sm:mx-0 sm:px-0">
            <button onClick={() => scrollTo('how-it-works')} className="text-sm font-medium text-slate-600 hover:text-red-600 whitespace-nowrap">使用流程</button>
            <button onClick={() => scrollTo('specs')} className="text-sm font-medium text-slate-600 hover:text-red-600 whitespace-nowrap">硬件参数</button>
          </div>
        </div>
      </div>
