    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 selection:bg-red-100 selection:text-red-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-4">
              ...
              <button onClick={() => setShowQR(true)} className="bg-red-600 text-white px-5 py-2 rounded-full text-sm font-medium hover:bg-red-700 transition-colors shadow-sm shadow-red-600/20">
                立即预定
              </button>
            </div>
          </div>
      ...
      <section className="relative pt-20 pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center max-w-3xl mx-auto">
            ...
            >
              <button onClick={() => setShowQR(true)} className="w-full sm:w-auto bg-red-600 text-white px-8 py-4 rounded-full text-lg font-medium hover:bg-red-700 transition-all shadow-lg shadow-red-600/30 flex items-center justify-center gap-2 group">
          ...
          >
            <div className="rounded-2xl shadow-2xl overflow-hidden border border-zinc-200 relative flex items-center justify-center bg-white">
              <img src="/box/5050e13500344491bce2018ece160efd.png" alt="产品实拍图" className="w-full h-auto object-cover" />
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section id="how-it-works" className="py-24 bg-slate-900 text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">产品介绍，全程不超过 3 分钟</h2>
